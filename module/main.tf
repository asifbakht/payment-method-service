module "vas_secrets" {
  ...
  replica_region = var.support_secondary ? [var.secondary_region] : []
}
...
module "sqs_iam" {
  ...
  sqs_queue_arns    = var.support_secondary ? [module.vas_sqs_primary.sqs_queue_arn, module.vas_sqs_secondary[0].sqs_queue_arn] : [module.vas_sqs_primary.sqs_queue_arn]
